...
void MiscTab() {
    ...
    {//right
        ...
        ImGui::MenuChild(_("HvH (autism)"), ImVec2(300, 280), false, ImGuiWindowFlags_NoScrollWithMouse);
        {
            ...
            const char* realYaw[]{ "None", "Left", "Right", "Backwards", "Spin", "Jitter Spin"}; ImGui::Combo(_("Real yaw"), &Vars::AntiHack::AntiAim::YawReal.m_Var, realYaw, IM_ARRAYSIZE(realYaw));
            const char* fakeYaw[]{ "None", "Left", "Right", "Backwards", "Spin", "Jitter Spin"}; ImGui::Combo(_("Fake yaw"), &Vars::AntiHack::AntiAim::YawFake.m_Var, fakeYaw, IM_ARRAYSIZE(fakeYaw));
