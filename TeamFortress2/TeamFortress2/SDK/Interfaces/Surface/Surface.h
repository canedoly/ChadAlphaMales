...
public:
	...
	*/
	...
	void DrawOutlinedCircle(int x, int y, float radius, int segments)
	{
		...
		GetVFunc<FN>(this, 99)(this, x, y, radius, segments); //doesn't work?
	}
	...
	void DrawSetTextureRGBAEx(int id, unsigned char const* rgba, int wide, int tall, ImageFormat imageFormat) {
		typedef void(__thiscall* FN)(PVOID, int, unsigned char const*, int, int, ImageFormat);
	...
	{
		return getvfunc<void(__thiscall*)(PVOID, int, unsigned char const*, int, int, ImageFormat)>(this, 119)(this, id, rgba, wide, tall, imageFormat);
	}
	*/
	...
	void DrawTexturedPoly(int n, Vertex_fart* vertices, bool bClipVertices = true)
	{
		typedef void(__thiscall* OriginalFn)(PVOID, int, Vertex_fart*, bool);
		return 	GetVFunc<OriginalFn>(this, 102)(this, n, vertices, bClipVertices);
	}
