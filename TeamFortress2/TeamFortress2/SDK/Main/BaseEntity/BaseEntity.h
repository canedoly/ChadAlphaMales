...
public: //Netvars & conditions
    M_DYNVARGET(NextNoiseMakerTime, float, this, _("DT_TFPlayer"), _("m_Shared"), _("m_flNextNoiseMakerTime"))
        ...
        M_DYNVARGET(MoveType, MoveType_t, this + 0x1A4, _("DT_BaseEntity"), _("movetype")) // 0x1A4 fixes the movetype, you can finally noclip
...
public: //Everything else, lol.
    ...
    __inline CTFPlayerAnimState* GetAnimState() {
        return *reinterpret_cast<CTFPlayerAnimState**>(this + 0x1BF8); //0x6FE previously
    }
    ...
    __inline Vec3 GetShootPos() {
        static auto Weapon_ShootPositionFn = reinterpret_cast<float* (__thiscall*)(PVOID, Vec3*)>(g_Pattern.Find(_(L"client.dll"), _(L"55 8B EC 56 8B 75 08 57 8B F9 56 8B 07 FF 90")));
        Vec3 vOut = Vec3();
