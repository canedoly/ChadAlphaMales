...
void __cdecl GetDrawPositionHook::Hook(float *pX, float *pY, bool *pbBehindCamera, Vec3 angleCrosshairOffset)
{
	...
	else if (Vars::Visuals::ThirdpersonCrosshair.m_Var && (Vars::Visuals::ThirdpersonOffsetX.m_Var != 0 || Vars::Visuals::ThirdpersonOffsetY.m_Var != 0 || Vars::Visuals::ThirdpersonOffsetZ.m_Var != 0) && g_Interfaces.Input->CAM_IsThirdPerson() && !(Vars::Misc::Freecam.m_Var && GetAsyncKeyState(Vars::Misc::FreecamKey.m_Var))) {
